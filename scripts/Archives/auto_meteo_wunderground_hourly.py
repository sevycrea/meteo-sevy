...
API_KEY = "de1b65ccc1fd4d6d9b65ccc1fded6d93"  # ⚠️ À REMPLACER
STATION_ID = "IVINEL2"
...
JSON_FILE = f"{BASE_DIR}/data/json/meteo_data_hourly.json"
BACKUP_DIR = f"{BASE_DIR}/data/json/backup"
LOG_FILE = f"{BASE_DIR}/logs/auto_wunderground_hourly.log"

# FTP (pour upload vers WordPress)
FTP_HOST = "ig6i34.ftp.infomaniak.com"  # ⚠️ À CONFIGURER
